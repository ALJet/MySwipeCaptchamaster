...
import indi.aljet.myswipecaptcha_master.R;

import static indi.aljet.myswipecaptcha_master.captchalib.DrawHelperUtils.drawPartCircle;
...
public class SwipeCaptchaView extends ImageView {
    ...
    private static final String TAG  = SwipeCaptchaView.class.getName();
    //控件的宽高
